...
warningNotification("Voidware x Cat V5", "Credits for all the modules belong to Cat V5 and its owner new_qwertyui#0", 10)
                ...
                if v.Character:FindFirstChild("BeastPowers") == nil then
                    ...
                    if v.Name ~= lplr.Name then
                        if v.Character:FindFirstChild("WarningNotifDetector") == nil then
                            ...
                            warningNotification("Voidware x Cat V5", v.Name.." is the beast!",10)
                        end
                    end
                end
            end)
                    ...
                    --pcall(function()
                        ...
                        if mag <= Range.Value then
                            if math.floor(tick() - hasNotified) > 10 then
                                warningNotification("Voidware x Cat V5", "The beast is near you!", 10)
                                hasNotified = tick()
                            end
                        end
                    --end)
